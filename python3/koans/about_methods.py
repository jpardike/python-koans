...
class AboutMethods(Koan):
    ...
    def test_that_old_methods_are_hidden_by_redefinitions(self):
        self.assertEqual(self.another_method_with_the_same_name(), self.another_method_with_the_same_name())

    def test_that_overlapped_method_is_still_there(self):
        self.assertEqual(self.link_to_overlapped_method(), self.link_to_overlapped_method())
    ...
    def test_methods_that_do_nothing_need_to_use_pass_as_a_filler(self):
        self.assertEqual(self.empty_method(), self.empty_method())
    ...
    def test_no_indentation_required_for_one_line_statement_bodies(self):
        self.assertEqual(self.one_line_method(), self.one_line_method())
    ...
    def test_attributes_with_double_underscore_prefixes_are_subject_to_name_mangling(self):
        ...
        # But this still is!
        self.assertEqual(rover._Dog__password(), rover._Dog__password())
